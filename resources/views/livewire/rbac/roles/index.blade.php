...
<div>
    <div class="mb-3">
        ...
        <div class="d-flex justify-content-end mb-4">
            <a href="{{ route('rbac.roles.create') }}" class="btn btn-primary">Buat peran</a>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="d-flex flex-column flex-md-row gap-2">
                ...
                <div class="mb-4">
                    <input id="text" type="text" class="form-control" placeholder="Cari peran" wire:model.lazy="search">
                </div>
                <div class="mb-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2 flex-column flex-md-row">
                                    <a href="{{ route('rbac.roles.edit', $role) }}" class="btn btn-primary">Edit</a>
                                    <button class="btn btn-danger" wire:click="deleteConfirm('{{ $role->id }}', '{{ $role->name }}')">
                                        Hapus
                                    </button>
                                </div>
                            </td>
